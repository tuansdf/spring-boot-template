...
public class AuthValidator {
    ...
    public void validateRegister(RegisterRequestDTO requestDTO) {
        ...
        if (StringUtils.isBlank(requestDTO.getUsername())) {
            throw new CustomException(localeHelper.getMessage("validation.error.required", new LocaleKey("field.username")));
        }
        ...
        if (StringUtils.isBlank(requestDTO.getEmail())) {
            throw new CustomException(localeHelper.getMessage("validation.error.required", new LocaleKey("field.email")));
        }
        ...
        if (StringUtils.isEmpty(requestDTO.getPassword())) {
            throw new CustomException(localeHelper.getMessage("validation.error.required", new LocaleKey("field.password")));
        }
    ...
    public void validateLogin(LoginRequestDTO requestDTO) {
        ...
        if (requestDTO.getUsername().length() > 255) {
            throw new CustomException(localeHelper.getMessage("validation.error.over_max_length", new LocaleKey("field.username"), 255));
        }
        if (StringUtils.isEmpty(requestDTO.getPassword())) {
            throw new CustomException(localeHelper.getMessage("validation.error.required", new LocaleKey("field.password")));
        }
