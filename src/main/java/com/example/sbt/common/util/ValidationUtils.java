...
public class ValidationUtils {
    ...
    public static String validatePassword(String input) {
        ...
        if (input.length() < 12 || input.length() > 64) {
            return LocaleHelper.getMessage("form.error.not_between_length", "##field.password", 12, 64);
        }
        return null;
    }
    ...
    public static String validateCode(String input) {
        if (StringUtils.isEmpty(input)) return null;
        if (input.length() > 255) {
            return LocaleHelper.getMessage("form.error.over_max_length", "##field.code", 255);
        }
        if (!ValidationUtils.isPattern(input, Regex.CODE)) {
            return LocaleHelper.getMessage("form.error.invalid", "##field.code");
        }
        return null;
    }
    ...
    public static String validateEmail(String input) {
        if (StringUtils.isEmpty(input)) return null;
        if (input.length() > 255) {
            return LocaleHelper.getMessage("form.error.over_max_length", "##field.email", 255);
        }
        if (!ValidationUtils.isEmail(input)) {
            return LocaleHelper.getMessage("form.error.invalid", "##field.email");
        }
        return null;
    }
    ...
    public static String validateUsername(String input) {
        if (StringUtils.isEmpty(input)) return null;
        if (input.length() < 3) {
            return LocaleHelper.getMessage("form.error.under_min_length", "##field.username", 3);
        }
        if (input.length() > 64) {
            return LocaleHelper.getMessage("form.error.over_max_length", "##field.username", 64);
        }
        if (!isPattern(input, Regex.USERNAME)) {
            return LocaleHelper.getMessage("form.error.invalid", "##field.username");
        }
        return null;
    }
